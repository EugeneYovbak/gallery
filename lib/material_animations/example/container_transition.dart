...
import 'package:gallery/material_animations/animations.dart';
          ...
          ...List<Widget>.generate(10, (int index) {
            return OpenContainer<bool>(
              ...
              closedBuilder: (BuildContext _, VoidCallback openContainer) {
                return ListTile(
                  leading: Image.asset(
                    'assets/transitions/avatar_logo.png',
                    width: 40,
                  ),
                  onTap: openContainer,
...
class _OpenContainerWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OpenContainer<bool>(
      ...
      onClosed: onClosed,
      tappable: false,
      closedBuilder: closedBuilder as CloseContainerBuilder,
    );
  }
}
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child: Center(
                child: Image.asset(
                  'assets/transitions/placeholder_image.png',
                  width: 100,
                ),
              ),
            ),
